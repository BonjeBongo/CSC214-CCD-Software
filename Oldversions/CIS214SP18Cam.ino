...
//nop delay for 192MHZ (oc) in microseconds (5 microseconds per nop instrudtion)
#define NOP "nop\n\t"
#define DELAY5 __asm__(NOP);
#define DELAY10 __asm__(NOP NOP);
#define DELAY15 __asm__(NOP NOP NOP);
#define DELAY20 __asm__(NOP NOP NOP NOP);
#define DELAY25 __asm__(NOP NOP NOP NOP NOP);
#define DELAY30 __asm__(NOP NOP NOP NOP NOP NOP);
#define DELAY35 __asm__(NOP NOP NOP NOP NOP NOP NOP);
#define DELAY40 __asm__(NOP NOP NOP NOP NOP NOP NOP NOP);
#define DELAY45 __asm__(NOP NOP NOP NOP NOP NOP NOP NOP NOP);
#define DELAY50 __asm__(NOP NOP NOP NOP NOP NOP NOP NOP NOP NOP);
#define DELAY55 __asm__(NOP NOP NOP NOP NOP NOP NOP NOP NOP NOP NOP);
#define DELAY60 __asm__(NOP NOP NOP NOP NOP NOP NOP NOP NOP NOP NOP NOP);
#define DELAY65 __asm__(NOP NOP NOP NOP NOP NOP NOP NOP NOP NOP NOP NOP NOP);
#define DELAY70 __asm__(NOP NOP NOP NOP NOP NOP NOP NOP NOP NOP NOP NOP NOP NOP);
...
//bits SPI
#define VID_CSBIT 0b10000				        //C (1 << 4)
...
#define READ pxR = ADCR(); // row[xsize-k] = pxR;
...
void get_frame() {  //params specified by host need to do it in overload potentially 
  ...
  if (ysize != frameHeight || xsize != frameWidth){
...
// void full_frame(){
//   row = new int[frameWidth];
//   int pxR = 0;
//   for (int ln=0; ln<frameHeight; ln++){
//     VERTICAL
//     for (int px=0; px<frameWidth; px++){
//       RESET
//       HORIZONTAL
//       pxR = ADCR();   //read value
//       row[frameHeight-px] = pxR   //add val to row
//     }
//     //send to host
//   }
// }
